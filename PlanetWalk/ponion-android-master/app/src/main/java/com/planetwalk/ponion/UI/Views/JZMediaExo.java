...
import com.planetwalk.ponion.UI.PonionMainActivity;
...
public class JZMediaExo extends JZMediaInterface implements Player.EventListener, VideoListener {
	...
	private static final int MAX_CACHE_VIDEO_FILE = 100 * 1024 * 1024;
...
//                    Util.getUserAgent(context, context.getResources().getString(R.string.app_name)));
			...
			DataSource.Factory dataSourceFactory = new DefaultDataSourceFactory(context,
					Util.getUserAgent(context, context.getResources().getString(R.string.app_name)));
			LeastRecentlyUsedCacheEvictor evictor = new LeastRecentlyUsedCacheEvictor(MAX_CACHE_VIDEO_FILE);
			File cacheDir = new File(context.getCacheDir(), "video-cache");
			videoCache = new SimpleCache(cacheDir, evictor);
			dataSourceFactory = new CacheDataSourceFactory(videoCache, dataSourceFactory);
